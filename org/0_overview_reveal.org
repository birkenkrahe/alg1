...
Syllabus is available on [[https://lyon.instructure.com/courses/2623/assignments/syllabus][Canvas]] and on [[https://github.com/birkenkrahe/alg1/blob/main/org/syllabus.org][GitHub]].
...
- Implement various data structures in C (with some C++ / Python / R /
  Java)
...
- Use Google chat to share stuff
...
- Update with freeCodeCamp (3 hoursh) / The Rook's Guide to C++ (100
  pages)
...
- You can install Linux via dual boot / VirtualBox or (on Windows)
  with WSL
- Use GitHub as a central repo and clone to your local machine(s)
