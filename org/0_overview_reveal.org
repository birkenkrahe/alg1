...
This material is shared across my courses. Apologies if you have to
...
- Check out Google Cloud Shell
- Go to cloud.google.com/shell
- Login using your Lyon Google account
- Follow my lead to Linux + Emacs + Org-mode
- See handout
...
- If you have not worked with Emacs, here's your first lesson. You may
  need to work through the tutorial again to get your skills back:
  [[https://github.com/birkenkrahe/org/blob/master/emacs/tutorial.md][tinyurl.com/emacs-tutor]] for v1, tinyurl.com/emacs-tutor2 for v2.
...
- Org-mode is a built-in Emacs package 
- Org-mode is 100% plain-text
- Org-mode developed by a German physicist
...
- Update your fork of my course repo.
- Automatic access to the latest materials.
- PC: Install =git= and =clone= the repo.
- Emacs: Install =magit= and use Git that way.
