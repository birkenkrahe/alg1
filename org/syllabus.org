...
- C++ language reference (written by a group of student volunteers
  over a weekend!): Rook's Guide to C++ (Hansen, 2013) - [[https://rooksguide.org/wp-content/uploads/2013/12/rooks-guide-isbn-version.pdf][Online]]. An
  auto-generated test with 100 questions is available for that book.
