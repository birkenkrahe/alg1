...
- Textbook (optional): Zingaro, Algorithmic Thinking (2e),
  NoStarch 2024.  Also very good: Shaw, Learn C the Hard Way,
  Addison-Wesley, 2015. The complete C reference: King, C Programming
  (2e) W W Norton (2008).
