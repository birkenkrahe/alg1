...
- [ ] Last quiz (10) and assignments on strings (with bonus) available
- [ ] Exit quiz on current topics as bonus in last week of term
- [ ] Lecture: Command-line arguments =main(int argc, char *argv[])=
...
** NEXT Review: Strings II (see also quiz 10)
...
6. How does can you iterate over a string =str= with pointer arithmetic?
   #+begin_quote
...
8. What is the key difference between calling a string function =void
   ...
   literals point to read-only memory.
   #+end_quote
...
** TODO Command-line arguments - passing stuff to a C program

[Re-] open your string code along file.


** TODO =struct= data structures

- Download this file to code along & practice:
  [[https://tinyurl.com/structures-org][tinyurl.com/structures-org]]
...
- We'll discuss:
  ...
  2. [ ] Initializing and operating on structures
  3. [ ] Structure types: Tags and type definition
  4. [ ] Structures as arguments and return values
  5. [ ] Creating structures on the fly as compound literals
  6. [ ] Nested arrays and arrays of structures
