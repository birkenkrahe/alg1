...
#+attr_html: :width 600px:
[[../img/vim_emacs_nano.jpg]]

** Assignment review
#+attr_html: :width 600px:
[[../img/submission.png]]

*** A look at a sad,sad gradebook (snapshot, Sat 14-Sep, 2.20 pm)
#+attr_html: :width 150px:
[[../img/gradebook.png]]

- *Let me know if you resubmit an assignment (I won't keep checking)*

- *Complete assignments even late if you must (I'm very negotiable)*

**** Array practice: compute the course average using C!
#+begin_src C :tangle main.c
  int i, n;
...
#+begin_quote
You know the answer: You will be judged according to the rubric. Data
structures is not an introductory course for people who want to see if
programming is for them. It's a serious, difficult collection of
topics that you need to master on your way towards becoming a computer
or data science professional.
#+end_quote
*** Which rubric?
#+attr_html: :width 600px:
[[../img/rubric.png]]
...
* Week 6 - Pointers and Arrays of Pointers
* Week 7 - String Manipulation
* Week 8 - Structs, Enums, Unions
* Week 9 - Dynamic Storage Allocation
* Week 10 - Linked Lists and Doubly Linked Lists
