...
#+caption: Sculpture from the group Les Voyageurs by Bruno Catalano (Marseille, France)
...
* TODO On the Programming Assignments
#+attr_html: :width 400px: 
...
* TODO Review: Intro to data structures / array basics
...
8. What do you get when you print undeclared array elements?
   #+begin_quote
   You get undefined behavior. Example: change the upper limit of the
   =Check results= loop from =5= to =10=. 
   #+end_quote
   #+begin_src C
     // Explicit initialization
     int A[5]; A[0]=A[1]=A[2]=A[3]=A[4]=0;
   ...
   A[4]: 0 B[4]: 0 C[4]: 0 
   A[5]: 0 B[5]: 0 C[5]: 0 
   A[6]: -297855783 B[6]: -1075053569 C[6]: 279048704 
   A[7]: 32764 B[7]: 0 C[7]: -919444582 
   A[8]: 0 B[8]: 0 C[8]: 1 
   A[9]: 0 B[9]: 0 C[9]: 0 
   #+end_example
9. When is the length of an array determined?
   ...
   its length is determined when the program is run.
   #+end_quote
