...
9. What will this code print?
   #+begin_src C
     int i = 10000000000; // 10,000,000,000
     printf("%d\n",i);
   #+end_src
...
* NEXT Orientation II: Course Content (cont'd) & Development Tools
...
* Assignments (Details in Canvas) by next week (Monday)
...
2. Complete the Hello World Project in GitHub and share a screenshot
   ...
   You find detailed step-wise instructions in the =0_overview.org=
