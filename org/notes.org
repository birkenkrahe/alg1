...
* Week 9 - Recursion and Quicksort [Oct 14]
#+attr_html: :width 600px:
[[../img/quicksort.png]]
...
** DONE Popquiz results
#+begin_src R :file pophist.png :session *R* :results file graphics output :exports both
...
** DONE Anonymous poll: How much have you programmed (in any language) this week?
#+attr_html: :width 600px: 
[[../img/poll.png]]

Vote anonymously at strawpoll.com: [[https://strawpoll.com/LVyK2j9oQZ0][strawpoll.com/LVyK2j9oQZ0]]

** DONE "Why coding exercises are KILLING your progress"
#+attr_html: :width 600px: 
...
** NEXT A Treat: Why We Bother Trying to Manipulate Memory
#+attr_html: :width 400px: 
[[../img/memory-clip.png]]
...
** TODO Review: VLA / Compound Literals / lvalue and rvalue
...
9. Your program compiles but when you run it you get a "segmentation
   ...
   #+begin_src bash :results output 
     gcc flag.c -Wall -Wextra -o flag
     ls -l flag
     ./flag
   #+end_src
   Code block compilation example:
   #+begin_src C :tangle :flags -Wextra 
...
* Week 10 - Arrays and Pointers [Oct 21]
* Week 11 - Strings, Structs, Enums, Unions [Oct 28]
* Week 12 - Dynamic Storage Allocation and Lists [Nov 4]
* Week 13 - Stacks and Queues [Nov 11]
* Week 14 - Trees and Hash Tables [Nov 18]
* +Week 15 - Thanksgiving Break+
* Week 15 - Heaps and Graphs / C++ [Dec 2]
