...
*Solve as many problems as you can. Grade yourself and turn in the sheet.*

*I'll use the (confidential) data to give you hints on how to improve.*

*If you're done early, open Emacs and check your answers.*

*After 60 minutes, we'll review and a post-mortem at the end of class*.
...
1) *You don't do well under pressure.* To remove this obstacle, do the
   quiz all over (without peeking at the solutions):
   tinyurl.com/functions-popquiz.
...
4) Even you know what you should do *you can't make yourself do it*. If
   your resistance is overwhelming and feels crippling, and if getting
   to code and solve problem on a computer seems a terrible ordeal to
   you, *do not stay in computer and data science*. 
