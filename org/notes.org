...
* Week 9 - VLAs, Compound Literals, Recursion [Oct 14]
#+attr_html: :width 500px:
...
* Week 10 - Quicksort & Arrays and Pointers [Oct 21]
#+attr_html: :width 600px:
[[../img/quicksort.png]]
...
* Week 11 - Stack, Arrays & Pointers [Oct 28]
#+attr_html: :width 600px: 
#+caption: Caspar David Friedrich, Mondaufgang am Meer, 1822.
[[../img/mondaufgang_am_meer_CDF_1822.jpeg]]

** TODO Assignments and Tests (5 weeks from the end of term!)

- [ ] New bonus exercise: [[https://lyon.instructure.com/courses/2623/assignments/36047][Recursive Euclidean Algorithm]].

- [ ] See also "writing a GCD function" exercise in 4_recursion.org.

- [ ] Solution video for assignment 8 (VLA array concatenation):
...
- [ ] There will be 2 more assignments and about the same number of
  bonus assignments, and 3 more online tests.

- [ ] Remember: You can (but don't have to) write the *final exam*,
  which consists of a selection of 50 questions from all quizzes.

- [ ] Remember: You can build your own independent *research project*
...
- [ ] *Quicksort*: Will create the promised analysis videos when I find
  the time.


** TODO Algorithms - Spring'25
...
6) For mastery, come up with your own exercises.
7) For assistance, ask me and/or ask generative AI.
8) For deep dives, follow C developers on X.com
9) For deep learning, define your own large project.
10) For support, form a coding study group.
