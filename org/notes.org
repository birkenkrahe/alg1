...
* DONE Modus operandi: 10 suggestions
#+attr_html: :width 600px:
[[../img/mars.png]]
...
- [ ] [[https://github.com/birkenkrahe/alg1/blob/main/img/ch12_1.png][Pointers can point to array elements]]
- [ ] [[https://github.com/birkenkrahe/alg1/blob/main/img/ch12_3.png][Adding and subtracting pointers]]
- [ ] Comparing pointers
...
1. What is the primary purpose of the stack in memory organization?
   ...
   when the function is called, and deallocated when it is entered.
   #+end_quote
...
6. The following example is supposed to display a 10 x 10 arrangement
