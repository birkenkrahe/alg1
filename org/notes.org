...
** DONE Syllabus: About Using AI to write code for you or debug your code
...
** DONE Orientation II: Course Content (cont'd) & Development Tools
...
* IN PROGRESS Assignments (Details in Canvas) by next week (Tuesday)
