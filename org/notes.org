...
* Week 13 - Strings and structs [Nov 11]
#+attr_html: :width 400px:
[[../img/string_theory.png]]

- [ ] First video lecture on strings is live (quiz 9)
- [ ] Quiz 8 - Stack, scope and pointer arithmetic *due tonight*
- [ ] Structures (=struct=, =enum=, =union=)

** IN PROGRESS String video project

There will be quiz questions.

[[https://www.youtube.com/watch?v=aE5k6UyhYaA&list=PLwgb17bzeNygqkMODQYfL1BEWHzft3gsJ&pp=gAQBiAQB][See playlist on YouTube]].

1) [X] String literals (aka string constants) - 23 min
2) [ ] String variables
3) [ ] Reading and writing strings
...
* Week 14 - Dynamic memory allocation [Nov 18]
