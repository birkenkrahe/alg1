...
1. How would you compute the course average using VLAs in C! Here are
   the grades for you to copy: tinyurl.com/grades-assignment
   #+begin_src bash :results output :exports both
   ...
   #+begin_src R :session *R* :results output :exports both
     mean(read.csv("https://tinyurl.com/grades-assignment)
   #+end_src
...
Bonus question: why kind of array is =grades[n]=?
#+begin_quote
=grades[n]= is a Variable-Length Array:length is determined at run-time.
#+end_quote
