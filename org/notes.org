...
5. Challenge: Change where =p= points to, and the value of =i= using
   double pointers. 
   ...
   #+end_src
      ...
      Review array printing exercise and review multidimensional 



Inside the function, all variables (also pointers) are local
...
* =repdigit.c= Sample Solution (video)
