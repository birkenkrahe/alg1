...
* DONE Assignment 3 review - A sermon, code, questions, and some answers
#+attr_html: :width 600px:
[[../img/submission3.png]]
...
* DONE Review: VLA, Macros & Quiz 4 Preview
...
* NEXT Using the C debugger =gdb=
  #+attr_html: :width 400px:
  [[../img/pythontutor.png]]

- Tangle the original version of =repdigit.c= (no user input): get the
  raw file from tinyurl.com/repdigit-c:
  #+begin_src bash :results output :exports both
  ...
  #+RESULTS:
  : -rw-rw-r-- 1 aletheia aletheia 885 Sep 18 23:36 repdigit.c
