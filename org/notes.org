...
* TODO Results: Programming assignment
#+attr_html: :width 600px:
...
* NEXT Function prototypes & arguments vs. parameters (new handout)
#+attr_html: :width 400px:
[[../img/x.png]]

*"Code along until your fingers bleed" - yes though not literally.*


* Week 7 - Pointers and Arrays
